...
public class ToggleTrialRoom : MonoBehaviour
{
    ...
    public void OnClickToogle()
    {
        ...
        setting.listTrialRoom[index] = this.GetComponent<Toggle>().isOn;
        uiManagement.SendOnChangeGameSettingTrialsRoom(setting.listTrialRoom[index], index);
        uiManagement.SendSetting(this.gameObject.name, this.GetComponent<Toggle>().isOn);
    }

    public void UpdateToggle()
    {
        this.GetComponent<Toggle>().isOn = setting.listTrialRoom[index];
